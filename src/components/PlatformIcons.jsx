...
export function YouTubeIcon({ size = 18, color = '#f43f5e', className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function InstagramIcon({ size = 18, color = '#ec4899', className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TikTokIcon({ size = 18, color = '#06b6d4', className = '' }) {
  return (
    <svg
      width={size}
      height={size}
